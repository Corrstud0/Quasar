...
$execute unless entity @s[tag=datapipes_lib_iterative_fluid_system] run return run function datapipes_lib:fluid_transfer/push/as_generator_tank with entity @s data.fluids[{id:'$(id)'}]
