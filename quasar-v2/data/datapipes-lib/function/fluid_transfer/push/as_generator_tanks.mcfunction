...
execute if score tank_amount datapipes_lib matches 1.. if data storage datapipes_lib:temp array[0].pipe_on run function datapipes_lib:fluid_transfer/push/run_generator_tanks with storage datapipes_lib:temp array[0]
