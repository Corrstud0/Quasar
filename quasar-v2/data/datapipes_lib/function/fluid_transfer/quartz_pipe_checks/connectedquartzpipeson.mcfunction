execute if block ~ ~ ~ quartz_pillar run function datapipes_lib:fluid_transfer/quartz_pipe_checks/turnonquartzpipes
execute if block ~ ~ ~ chiseled_quartz_block run setblock ~ ~ ~ lime_glazed_terracotta[facing=west]
