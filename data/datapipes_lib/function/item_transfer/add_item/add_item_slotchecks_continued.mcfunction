...
data modify storage datapipes_lib item_to_add set from storage datapipes_lib current_item
execute store result storage datapipes_lib item_to_add.Count byte 1 run scoreboard players get output_item_amount datapipes_lib